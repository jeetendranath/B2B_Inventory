...
export default class ProductDetailsDisplay extends NavigationMixin(
    ...
    get _isAddToCartDisabled() {
        return this._invalidQuantity || !this.inStock || this.addToCartDisabled;
    }
    ...
    handleQuantityChange(event) {
        ...
        if(this.availableQty < this.quantity1)
        {
    ...
    updateReserved(){
        let quantity = this._quantityFieldValue;
        console.log("UpdateReserved "+ quantity);
        this.dispatchEvent(
            new CustomEvent('updatereservefield',{
                detail:{
                    quantity
                }
            })
